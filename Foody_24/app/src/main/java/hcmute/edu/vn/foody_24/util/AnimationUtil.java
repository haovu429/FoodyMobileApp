package hcmute.edu.vn.foody_24.util;
...
public class AnimationUtil {
    ...
    public static void translateAnimation(final ImageView viewAnimation, final View startView, View endView,
        ...
        startScaleAnimation.setDuration(ANIMATION_DURATION);

        ScaleAnimation translateScaleAnimation = new ScaleAnimation(fromX, toX, fromY, toY);
